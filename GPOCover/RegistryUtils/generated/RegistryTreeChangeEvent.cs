...
namespace GPOCover.RegistryUtils {
    ...
    public class RegistryTreeChangeEvent : System.ComponentModel.Component {
        ...
        private static string ConstructPath() {
            string strPath = "root\\cimv2:RegistryTreeChangeEvent";
            return strPath;
        }
        ...
        public static RegistryTreeChangeEventCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static RegistryTreeChangeEventCollection GetInstances(string condition, string[] selectedProperties) {
        ...
        public static RegistryTreeChangeEventCollection GetInstances(System.Management.ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static RegistryTreeChangeEventCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\cimv2";
